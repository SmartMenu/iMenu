...
// }
	onLanguageButtonSelect: function(oEvent) {
		...
		var l10nModifierData = null;
		var l10nSetterData = null;
		switch (language) {
			case "繁":
				...
				l10nModifierData = sap.ui.getCore().getModel("com.h3.prj.imenu.model.menuItemId_to_Modifier_zh_TW").getData();
				l10nSetterData = sap.ui.getCore().getModel("com.h3.prj.imenu.model.menuItemId_to_Setter_zh_TW").getData();
				break;
			case "EN":
				...
				l10nModifierData = sap.ui.getCore().getModel("com.h3.prj.imenu.model.menuItemId_to_Modifier_en_US").getData();
				l10nSetterData = sap.ui.getCore().getModel("com.h3.prj.imenu.model.menuItemId_to_Setter_en_US").getData();
				break;
		}
		...
		sap.ui.getCore().getModel("com.h3.prj.imenu.model.l10nModifier").setData(l10nModifierData);
		sap.ui.getCore().getModel("com.h3.prj.imenu.model.l10nSetter").setData(l10nSetterData);
